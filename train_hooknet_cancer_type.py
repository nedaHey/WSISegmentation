...
from src.dataset import DatasetHandlerHooknetCancerType
...
if __name__ == '__main__':
    ...
    assert config.OUTPUT_TYPE == 'cancer_type', "change OUTPUT_TYPE to 'cancer' in HookNetConfig, config.py"
    ...
    if not slides_dir.is_dir():
        ...
        dataset = DatasetHandlerHooknetCancerType(slides_dir,
                                                  contours_dir,
