...
from src.dataset import UNetDataHandlerBinary
from src.config import UNetDatasetConfig
...
if __name__ == '__main__':
    ...
    if not slides_dir.is_dir():
        ...
        dataset = UNetDataHandlerBinary(slides_dir,
                                        contours_dir,
        ...
        # model.summary()
        #
        # trainer = Trainer(checkpoints_dir, logs_dir, args.model_name, config.BATCH_SIZE)
        # trainer.train(model, train_data_gen, n_iter_train, val_data_gen, n_iter_val, config.EPOCHS)
