...
from src.dataset import DatasetHandlerUNetCancerType
...
if __name__ == '__main__':
    ...
    assert model_config.OUTPUT_TYPE == 'cancer_type', "change OUTPUT_TYPE to 'cancer' in ResUnetConfig, config.py"
    ...
    if not slides_dir.is_dir():
        ...
        dataset = DatasetHandlerUNetCancerType(slides_dir,
                                               contours_dir,
